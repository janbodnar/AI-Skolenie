...
4. *Slovenčina vyžaduje špeciálny prístup*: buď explicitný s jazykom, používaj modely s SK podporou, testuj a iteruj.
5. *Iterácia je kľúč*: Najlepšie prompty vznikajú po 2-3 kolách vylepšovania na základe spätnej väzby.
6. *Kritické myslenie zostáva ľudskou úlohou*: AI je nástroj – overovanie, etika a kontext sú na vás.
